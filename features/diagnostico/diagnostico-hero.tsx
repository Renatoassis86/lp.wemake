...
import { AlertCircle, ArrowRight, Building2, Mail, Phone, Sparkles, User2 } from "lucide-react";
...
/**
 * Hero da LP do ebook. Form simplificado (Etapa 1):
 *  - Nome / Email / WhatsApp / Escola / Consent LGPD
 *
 * A qualificação completa (cargo, espaço maker, tamanho, orçamento)
 * acontece na /obrigado, ANTES do download do ebook.
 */
          ...
          <div className="order-1">
            <Reveal>
              <div className="relative inline-block mb-6">
                <div aria-hidden className="absolute -inset-1.5 bg-[rgb(var(--color-brand-mint))]/40 blur-xl rounded-full animate-pulse pointer-events-none" />
            ...
            <Reveal delay={0.15}>
              <p className="text-white/85 text-[0.9375rem] sm:text-[1rem] leading-relaxed mb-8 max-w-xl">
                ...
                que desejam ensinar tecnologia com propósito.
              </p>
            </Reveal>
...
function DevicesStack() {
  return (
    <div className="relative w-full max-w-[520px] aspect-[5/4] mx-auto lg:mx-0">
      ...
      >
        <div className="relative aspect-[16/10] rounded-t-xl bg-[#1a2333] p-2 ring-1 ring-white/15" style={{ boxShadow: "-10px 14px 38px rgba(0,0,0,0.45)" }}>
          ...
          <div className="relative w-full h-full rounded-md overflow-hidden bg-[rgb(var(--color-brand-navy))]">
            <Image src={COVER_SRC} alt="" fill priority sizes="(max-width: 768px) 240px, 360px" className="object-cover object-top" />
      ...
      >
        <div className="relative aspect-[3/4] rounded-[1.2rem] bg-[#1a2333] p-2 ring-1 ring-white/15" style={{ boxShadow: "-12px 18px 42px rgba(0,0,0,0.55)" }}>
          ...
          <div className="relative w-full h-full rounded-[0.85rem] overflow-hidden bg-[rgb(var(--color-brand-navy))]">
            <Image src={COVER_SRC} alt="" fill sizes="180px" className="object-cover object-center" />
      ...
      >
        <div className="relative aspect-[9/19] rounded-[1.4rem] bg-[#0e1424] p-[6px] ring-1 ring-white/20" style={{ boxShadow: "-10px 16px 36px rgba(0,0,0,0.55)" }}>
          ...
          <div className="relative w-full h-full rounded-[1rem] overflow-hidden bg-[rgb(var(--color-brand-navy))]">
            <Image src={COVER_SRC} alt="" fill sizes="100px" className="object-cover object-center" />
            <div className="absolute inset-0 bg-gradient-to-tr from-transparent via-white/8 to-transparent pointer-events-none" />
          </div>
...
function Atmosphere() {
  return (
    <>
      <div aria-hidden className="hidden md:block absolute -left-[20%] top-0 w-[50%] aspect-square rounded-full border-[60px] lg:border-[80px] border-[rgb(var(--color-brand-royal-deep))]/40 opacity-50" />
      <div aria-hidden className="hidden md:block absolute -right-[30%] top-1/3 -translate-y-1/3 w-[70%] aspect-square rounded-full border-[40px] lg:border-[50px] border-[rgb(var(--color-brand-royal-soft))]/30" />
    </>
  );
}
