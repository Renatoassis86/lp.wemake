...
import type { AnoProjetado } from "@/features/admin/apresentacao/apresentacao-plano";
...
/**
 * Dados compartilhados entre a apresentação interativa e a versão de
 * impressão/PDF, pra nunca desviarem: as duas usam exatamente a mesma busca.
 */
